...
export class UserProfileComponent implements OnInit {
  ...
  },
  {
    ...
    description: "Rebernia is a democratic restaurant where there`s no tableware and everyone eats with their hands (after all, it’s more delicious). And, of course, there is no entrance in ties. But if someone wants his tie to be publicly cut and added to our collection - why not?",
  },
  {
    id: 3,
    name: "Pub Good Friend",
    tags: ["Bar", "Pizza", "Fast Food"],
    priceRating: 1,
    rating: 4,
    ...
    description: "A great place for draught beers with a selection of 20 or so on a chalk board with descriptions. Also well crafted cocktails from an easy going english speaking bartender!",
  }
];
  ...
  user: User = {
    id: 1,
    fullName: "John Doe",
    email: "johndoe@mail.kp",
    dateOfBirth: new Date("1969-05-12"),
    location: "Lviv, Ukarine",
    userBookings: [
      {
        id: 1,
        restaurantName: "Baczewski Restaurant",
        bookingDate: new Date("2022-03-12T17:14:22"),
        rating: 5,
        priceRating: 3,
  ...
  discover(id: number): void {
    console.log(this.user.userBookings.filter(x => x.id == id)[0]);
  }
